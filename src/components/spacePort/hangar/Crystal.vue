<template>
    <div class="d-flex justify-content-center">
        <div v-for="crystal of Object.entries(savedPlayer[crystalProp].owned) as [string, TimeCrystal | PowerCrystal][]"
            class="border mb-1 p-1 me-1" :class="+crystal[0] == savedPlayer[crystalProp].selected ? 'border-dark' : ''"
            @click="selectedCrystal(+crystal[0])">
            <div v-for="stat of Object.keys(crystal[1]) as (keyof (TimeCrystal | PowerCrystal))[]" class="mb-1">
...
import { PowerCrystal, TimeCrystal } from '../../../types';
